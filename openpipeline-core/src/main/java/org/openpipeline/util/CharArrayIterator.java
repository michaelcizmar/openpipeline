...
/** 
 * This class is copied from Lucene. The reason we use it instead of our
 * own is the HAS_BUGGY_BREAKITERATORS flag. As of 7/9/2012, that bug is not
 * fixed. See bug #7104012:
