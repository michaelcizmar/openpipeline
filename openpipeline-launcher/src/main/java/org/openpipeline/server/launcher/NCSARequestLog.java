...
/**
 * This class is identical to the Jetty NCSARequestLog, except that
 * it logs to the default slf4j logger instead of the writer.
 * 
 * 
...
*/
	...
	public void log(Request request, Response response)
    {
		...
		buf.append(' ');
		buf.append(request.getRequestURI().toString());
		buf.append(' ');
